 ...
 */
export const WeatherToggle = GObject.registerClass(class WeatherToggle extends QuickMenuToggle {
    _settings;
    _snowButton = null;
    _rainButton = null;
    _buttonBox = null;
 ...
 */
export const WeatherIndicator = GObject.registerClass(class WeatherIndicator extends SystemIndicator {
    toggle;
    _indicator;
    _settings;
    _settingsHandler = null;
